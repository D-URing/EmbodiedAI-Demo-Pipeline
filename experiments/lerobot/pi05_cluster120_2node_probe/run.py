...
try:
    ...
    raise SystemExit("ERROR: PyYAML is required. Activate the LeRobot env first.") from exc
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run this LeRobot/pi05 distributed probe experiment.")
